/**
 */
package Trees.provider;


import Trees.Tree;
import Trees.TreeFactory;
import Trees.TreePackage;
...
/**
 * This is the item provider adapter for a {@link Trees.Tree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TreeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TreePackage.Literals.TREE__LABEL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TreePackage.Literals.TREE__CHILDREN);
		}
	...
	public String getText(Object object) {
		String label = ((Tree)object).getLabel();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TreePackage.Literals.TREE__CHILDREN,
				 TreeFactory.eINSTANCE.createTree()));
	}
